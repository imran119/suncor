...
annotate schema.AssetMainReport with {
...
//Instrument data
Engu @title : '{i18n>Engu}';
Eqlin @title : '{i18n>Eqlin}';

Linesz @title : '{i18n>Linesz}';
Insrng @title : '{i18n>Insrng}';
Sigspn @title : '{i18n>Sigspn}';
Sigzr @title : '{i18n>Sigzr}';
Instrmk @title : '{i18n>Instrmk}';

Ioloc @title : '{i18n>Ioloc}';
Iosigd @title : '{i18n>Iosigd}';
Iosigs @title : '{i18n>Iosigs}';
Iosigt @title : '{i18n>Iosigt}';
Iotyp @title : '{i18n>Iotyp}';

Inflp @title : '{i18n>Inflp}';
Pcunod @title : '{i18n>Pcunod}';
Pcumod @title : '{i18n>Pcumod}';
Pcumod2 @title : '{i18n>Pcumod2}';
Pcucab @title : '{i18n>Pcucab}';
Pcuslv @title : '{i18n>Pcuslv}';
Pcuslvc @title : '{i18n>Pcuslvc}';
Pcuslv2 @title : '{i18n>Pcuslv2}';

Ctlrmk @title : '{i18n>Ctlrmk}';
Almrmk @title : '{i18n>Almrmk}';

Firezn @title : '{i18n>Firezn}';
Matl @title : '{i18n>Matl}';
Alhg @title : '{i18n>Alhg}';
 

Alhh @title : '{i18n>Alhh}';

Pipspec @title : '{i18n>Pipspec}';
Sched @title : '{i18n>Sched}';

Inscls @title : '{i18n>Inscls}';
 Ndtcls @title : '{i18n>Ndtcls}';
Ptcls @title : '{i18n>}';
Fluid @title : '{i18n>Fluid}';


Poprmx @title : '{i18n>Poprmn}';
Poprmn @title : '{i18n>Poprmn}';

       
Tdesmx @title : '{i18n>Tdesmx}';
Tdesmn @title : '{i18n>Tdesmn}';
Ndtmp @title : '{i18n>Ndtmp}';
Toprmx @title : '{i18n>Toprmx}';

Temptr @title : '{i18n>Temptr}';

}
/*
annotate schema.AssetMain_Doc with {
...
/*
annotate schema.ZEDF4_Header with {
Cdgrp @title : '{i18n>Cdgrp}';
Cdgrpdsc @title : '{i18n>Cdgrpdsc}';
};

annotate schema.ZEDF4_Detail with {
